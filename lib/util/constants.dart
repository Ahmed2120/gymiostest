...
class Constants {
  ...
  static DateFormat addDateFormat = DateFormat(
      "dd-MM-yyyy", Get.locale == null ? "en-US" : Get.locale?.countryCode);
  static DateFormat showDateFormat = DateFormat(
      "EEE dd MMMM", Get.locale == null ? "en-US" : Get.locale?.countryCode);

  static DateFormat timeFormats = DateFormat(
      "mm:ss", Get.locale == null ? "en-US" : Get.locale?.countryCode);
  static DateFormat historyTitleDateFormat = DateFormat(
      "MMMM dd, yyyy", Get.locale == null ? "en-US" : Get.locale?.countryCode);
  ...
  static String getAppLink() {
    String pkgName = "com.example.flutterwomenworkout";
