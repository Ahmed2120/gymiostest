...
class _HealthInfo extends State<HealthInfo> {
  String selectedGender = "Female".tr;
  double weight = 50;
  double height = 100;
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  getCustomText("Gender".tr, textColor, 1,
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  getCustomText("Height".tr, textColor, 1,
                                      TextAlign.start, FontWeight.w500, 15.sp),
                                  getCustomText(
                                      (isKg)
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  getCustomText("Weight".tr, textColor, 1,
                                      TextAlign.start, FontWeight.w500, 15.sp),
                                  getCustomText(
    ...
    return ConstantWidget.getPaddingWidget(
      ...
      Row(
        children: [
          ...
          getCustomText("Health info".tr, textColor, 1, TextAlign.start,
  ...
  void showGenderSelectionDialog(BuildContext contexts) async {
    List<String> ringTone = ['Female'.tr, 'Male'.tr];
          ...
          builder: (context, setState) {
            return AlertDialog(
              title: getMediumBoldTextWithMaxLine(
                  "Select Gender".tr, Colors.black87, 1),
              content: Container(
                width: 300,
                height: 100,
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: ConstantWidget.getDefaultTextFiledWithLabel(
                            context, "Weight".tr, myController,
                            isEnable: false,
                            height: 60.h,
                            withprefix: false,
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: getButton(
                              context, accentColor, "Cancel".tr, Colors.white,
                              () {
                        Get.back();
                      }, 20.sp,
                      ...
                      Expanded(
                          child: getButton(
                              context, Colors.white, "Submit".tr, textColor,
                              () {
