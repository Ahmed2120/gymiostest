...
class WorkoutSubCategoryList extends StatefulWidget {
  const WorkoutSubCategoryList({Key? key, required this.catId})
      : super(key: key);

  final String catId;

  @override
  State<WorkoutSubCategoryList> createState() => _WorkoutSubCategoryListState();
}

class _WorkoutSubCategoryListState extends State<WorkoutSubCategoryList>
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    getCustomText("Workout Sub Categories", textColor, 1,
                ...
                Expanded(
                    ...
                    child: FutureBuilder<ModelAllWorkout?>(
                      future: getSubYogaWorkout(context, widget.catId),
