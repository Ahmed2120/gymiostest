...
class WorkoutCategory extends StatefulWidget {
  ...
  @override
  _WorkoutCategory createState() => _WorkoutCategory();
}
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Image.network(
                                      "${ConstantUrl.uploadUrl}${widget._modelExerciseDetail.thumb}"),
                                ),
                                ConstantWidget.getHorSpace(12.h),
                                Expanded(
                                  child: Column(
...
class _WorkoutCategory extends State<WorkoutCategory>
    with WidgetsBindingObserver {
  int pos = 0;
  bool isSkip = false;
  double getCal = 0;
  ...
  getVolume() {
    print("tts_volume----------${settingController.volume.value}");
  ...
  getDetailWidget() {
    ...
    if (isSkip) {
      ...
      if (!isReady) {
        ...
        _speak(Localizations.localeOf(context).languageCode == 'en-US'
