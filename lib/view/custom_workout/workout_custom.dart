...
import 'package:flutter_women_workout_ui/view/youtube_widget/custom_exercise_youtube_widget_bottom_sheet.dart';
...
class _WidgetSkipData extends State<WidgetSkipData>
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Image.network(
                                      "${ConstantUrl.uploadUrl}${widget._modelExerciseDetail.exercisedetail.thumb}"),
                                ),
                                ConstantWidget.getHorSpace(12.h),
                                Expanded(
                                  child: Column(
  ...
  void showBottomDialog(Customplanexercise exerciseDetail, bool isVideo) {
    ...
    //   initialVideoId: exerciseDetail.exercisedetail.image,
    ...
    showModalBottomSheet<void>(
      ...
      context: context,
      builder: (context) {
        return CustomExerciseYoutubeWidgetBottomSheet(
...
class _WidgetDetailData extends State<WidgetDetailData>
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: widget._modelExerciseDetail.exercisedetail.image,
      flags: YoutubePlayerFlags(
        autoPlay: true,
        hideControls: true,
...
class _WorkoutCustom extends State<WorkoutCustom> with WidgetsBindingObserver {
  ...
  getDetailWidget() {
    ...
    if (isSkip) {
      ...
      if (!isReady) {
        _speak(
            "Ready to go start with ${Localizations.localeOf(context).languageCode == 'en-US' ? _modelExerciseDetail.exercisedetail.exerciseName : _modelExerciseDetail.exercisedetail.exerciseNameAr}");
        playBgSound("audio1.mp3");
      } else {
        _speak(
          Localizations.localeOf(context).languageCode == 'en-US'
              ? _modelExerciseDetail.exercisedetail.exerciseName
              : _modelExerciseDetail.exercisedetail.exerciseNameAr,
        );
