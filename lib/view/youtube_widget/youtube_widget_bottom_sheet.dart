...
import 'package:flutter_women_workout_ui/models/model_detail_exercise_list.dart';
...
class YoutubeWidgetBottomSheet extends StatefulWidget {
  const YoutubeWidgetBottomSheet({Key? key, required this.exerciseDetail})
      : super(key: key);
  final Exercise exerciseDetail;

  @override
  State<YoutubeWidgetBottomSheet> createState() =>
      _YoutubeWidgetBottomSheetState();
}

class _YoutubeWidgetBottomSheetState extends State<YoutubeWidgetBottomSheet> {
