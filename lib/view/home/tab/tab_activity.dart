          ...
          builder: (context, setState) {
            return AlertDialog(
              title: getMediumBoldTextWithMaxLine(
                  "Enter Height and Weight".tr, Colors.black87, 1),
              content: Container(
                width: 300.0,
                padding:
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    getCustomText("Height".tr, Colors.black87, 1,
                    ...
                    getCustomText("Weight".tr, Colors.black87, 1,
                        TextAlign.start, FontWeight.w600, 20),
                    SizedBox(
                      height: 2,
                    ),
          ...
          Expanded(
            ...
            child: ListView(
              ...
              children: [
                ...
                buildCaloriesWidget(),
                ConstantWidget.getVerSpace(20.h),
                getCustomText("BMI Calculator".tr, textColor, 1,
                ...
                Row(
                  children: [
                    Expanded(
                      child: getCustomText('Summary'.tr, textColor, 1,
                          TextAlign.start, FontWeight.w700, 20.sp),
                      flex: 1,
                    ),
                  ],
        ...
        children: [
          ConstantWidget.getPaddingWidget(
            ...
            Row(
              ...
              children: [
                getCustomText("Weight".tr, textColor, 1, TextAlign.start,
                ...
                InkWell(
                  ...
                  child: Row(
                    children: [
                      getCustomText("Add".tr, textColor, 1, TextAlign.end,
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData && snapshot.data != null) {
            WorkoutHistoryModel? modelWorkout =
                snapshot.data as WorkoutHistoryModel?;
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        ConstantWidget.getHorSpace(4.h),
                                        getCustomText(
                                            "${_modelWorkoutList.kcal} ${"Calories".tr}",
                                            textColor,
                                            1,
                                            TextAlign.start,
                                            FontWeight.w500,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          getButton(context, accentColor, "Check now".tr, Colors.white, () {
            if (isKg) {
          ...
          builder: (controller) => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                getCustomText("Burn Calories".tr, textColor, 1,
                    TextAlign.center, FontWeight.w700, 17.sp),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      getCustomText(
                          "$getTodayTotalWorkout ${"Workout".tr}",
                          textColor,
                          1,
                          TextAlign.center,
                          FontWeight.w700,
    ...
    return GetBuilder<SettingController>(
        ...
        builder: (controller) => CircularPercentIndicator(
              ...
              center: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  getCustomText("Active Calories".tr, descriptionColor, 1,
    ...
    return Row(
      ...
      children: [
        ConstantWidget.getTextWidget(
            "Today".tr, textColor, TextAlign.start, FontWeight.w600, 18.sp),
        ...
        children: [
          Row(
            children: [
              ...
              getCustomText("Activity".tr, textColor, 1, TextAlign.start,
