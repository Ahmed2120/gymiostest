...
ModelGetCustomPlan modelGetCustomPlanFromJson(String str) =>
    ModelGetCustomPlan.fromJson(json.decode(str));

String modelGetCustomPlanToJson(ModelGetCustomPlan data) =>
...
class ModelGetCustomPlan {
  ...
  factory ModelGetCustomPlan.fromJson(Map<String, dynamic> json) =>
      ModelGetCustomPlan(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        customplan: json["success"] == 0
            ? []
            : List<Customplan>.from(
                json["customplan"].map((x) => Customplan.fromJson(x))),
        error: json["error"],
      );
