...
WorkoutHistoryModel workoutHistoryModelFromJson(String str) =>
    WorkoutHistoryModel.fromJson(json.decode(str));

String workoutHistoryModelToJson(WorkoutHistoryModel data) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json["workoutcompleted"] == null) {
      ...
      list = List<CompletedHistoryworkout>.from(json["workoutcompleted"]
          .map((x) => CompletedHistoryworkout.fromJson(x)));
    }
  ...
  Map<String, dynamic> toJson() => {
        "success": success,
        "completedworkout":
            List<dynamic>.from(completedworkout!.map((x) => x.toJson())),
        "error": error,
      };
}
...
class CompletedHistoryworkout {
  ...
  factory CompletedHistoryworkout.fromJson(Map<String, dynamic> json) =>
      CompletedHistoryworkout(
